...
\begin{figure}
	\centering
	\includegraphics[scale=0.7]{images/hierarchia_uprawnien.png}
	\caption{Hierarchię uprawnień pomiędzy użytkownikami}
\end{figure}
...
Przedstawione nazwy grup, są grupami domyślnymi w platformie Spring Security. Oznacza to, że nie musimy definiować dziedziczenia uprawnień pomiędzy nimi. Domyślnie grupa ROLE\_USER dziedziczy uprawnienia grupy IS\_AUTHENTICATED\_ANONYMOUSLY, natomiast ROLE\_ADMIN, dziedziczy uprawnienia z ROLE\_USER.
