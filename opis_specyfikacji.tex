...
\begin{table}[H]
    ...
    \hline\end{tabular}
	\caption{UC00 - Dodawanie przedmiotu}
\end{table}
...
\begin{table}[H]
    ...
    \hline\end{tabular}
	\caption{UC01 - Dodawanie recenzji}
\end{table}
...
\begin{table}[H]
    ...
    \hline\end{tabular}
	\caption{UC02 - Logowanie do serwisu}
\end{table}
...
\begin{table}[H]
    ...
    ~ & 2a.2. Powrót do punktu 1 \\
    \hline\end{tabular}
	\caption{UC03 - Rejestracja w serwisie}
\end{table}
\newpage
\begin{table}[H]
    \begin{tabular}{|p{5cm}|p{9cm}|}\hline
    ...
    \hline\end{tabular}
	\caption{UC04 - Dodawanie kategorii}
\end{table}
